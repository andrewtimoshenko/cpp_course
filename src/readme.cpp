...
Это можно сделать, например, с помощью функции lexicographical_compare https://ru.cppreference.com/w/cpp/algorithm/lexicographical_compare
, сравнивающей два диапазона элементов
